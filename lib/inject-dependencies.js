...
var replaceIncludes = function (fileType, returnType) {
  ...
  return function (match, startBlock, spacing, blockType, oldScripts, endBlock, offset, string) {
    ...
    string.
      replace(oldScripts, '').
      replace(fileTypes[fileType].detect[blockType], findReferences);
    ...
    dependencies.
      ...
      forEach(function (path) {
        newFileContents += spacing + fileTypes[fileType].replace[blockType].replace('{{filePath}}', path);
      });
